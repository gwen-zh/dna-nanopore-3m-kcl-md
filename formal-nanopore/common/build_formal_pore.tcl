...
# Load the validated pore/membrane/water template. The optional cleanup keeps
# the builder compatible with templates that already contain replaceable ions
# or a nucleic-acid segment.
readpsf $pore_psf
coordpdb $pore_pdb
catch {delatom ION}
catch {delatom ION1}
...
puts "FINAL label=$label atoms=$nall dna_atoms=$ndna water_atoms=$nwater potassium=$nk chloride=$ncl box=$minmax"
quit
