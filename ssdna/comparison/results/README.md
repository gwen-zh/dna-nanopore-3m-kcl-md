...
|---|---|---:|---:|---:|
| poly(dA)40 | 50 ns production | 2500–2999 | 45.01–50.00 ns | 5.00 ns |
...
heating and 9.5 ns equilibration. Exact input hashes and selected frame indices
...
The comparison uses equal 5 ns windows: 45.01–50.00 ns for dA40 and
0.01–5.00 ns for dT40. Each sequence is represented by one trajectory, so the
reported variation describes frames within these trajectories. Independent
replicas would be required to estimate population-level uncertainty or
